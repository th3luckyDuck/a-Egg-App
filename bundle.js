...
/* WEBPACK VAR INJECTION */(function(Please) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! @license Firebase v2.2.9
...
function properties(obj) {
  return _(obj).toPairs().map(function (_ref) {
...
AFRAME.registerComponent('scoreboard', {
  ...
  incrementScore: function incrementScore(event) {
    if (!event.target.matches(this.data.filter)) {
      return;
    }
  ...
  renderScores: function renderScores(snapshot) {
    ...
    ReactDOM.render(React.createElement(
      'a-entity',
      null,
      React.createElement('a-entity', { 'n-text': properties({ text: myScore }), position: '-0.85 0.405 -1.75', rotation: '-25 0 0', scale: '0.12 0.12 0.03', 'n-cockpit-parent': true }),
      sortedUsers.map(function (user, i) {
        return React.createElement(
          'a-entity',
          { position: '1.5 0.25 -9.5', rotation: '0 15 0', scale: '0.16 0.16 0.16' },
          React.createElement('a-entity', { 'n-text': properties({ text: truncate(user.displayName) }), position: '-2 ' + -i + ' 0' }),
          user.score > 200 && React.createElement('a-entity', { mixin: 'golden-egg', position: '6 ' + (-i - 0.2) + ' 0' }),
          React.createElement('a-entity', { 'n-text': properties({ text: user.score }), position: '4 ' + -i + ' 0' })
        );
      })
    ), this.el);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__altspace_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__altspace_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__altspace_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cached_model_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cached_model_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__cached_model_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scoreboard_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scoreboard_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__scoreboard_js__);
